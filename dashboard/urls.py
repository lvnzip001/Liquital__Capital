...
urlpatterns = [ 
    ...
    path('input_loan_portfolio', views_dashboard.data_input_portfolio, name='input_loan_portfolio'),
    ...
    path('portfolio_table', views_dashboard.portfolio_table, name='portfolio_table'),
    path('convert-to-df/<str:loan_database>/', views_dashboard.submit_upload, name='submit_upload'),
